...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Нова спеціальність') }}</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('specialty.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="name_special" type="text" class="form-control @error('name_special') is-invalid @enderror" name="name_special" value="{{ old('name_special') }}" required autocomplete="name_special" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="discr_special" type="text" class="form-control @error('discr_special') is-invalid @enderror" name="discr_special" value="{{ old('discr_special') }}" required autocomplete="discr_special" autofocus>
